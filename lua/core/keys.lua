...
-- Move Lines
map('n', '<A-j>', ':m .+1<CR>==', { desc = 'Move lines', silent = true })
map('v', '<A-j>', ":m '>+1<CR>gv=gv", { desc = 'Move lines', silent = true })
map('i', '<A-j>', '<Esc>:m .+1<CR>==gi', { desc = 'Move lines', silent = true })
map('n', '<A-k>', ':m .-2<CR>==', { desc = 'Move lines', silent = true })
map('v', '<A-k>', ":m '<-2<CR>gv=gv", { desc = 'Move lines', silent = true })
map('i', '<A-k>', '<esc>:m .-2<CR>==gi', { desc = 'Move lines', silent = true })
