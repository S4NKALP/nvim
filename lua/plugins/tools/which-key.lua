...
local normal_mappings = {
    ...
    { '<leader>eca', '<cmd>e ~/dotfiles/zsh/aliases.zsh<cr>', desc = 'Shell Aliases' },
    {
        '<leader>ecc',
    ...
    {
        '<leader>mb',
        "<cmd>lua require('telescope').extensions.markit_nvim.bookmarks_list_all()<cr>",
        desc = 'Bookmarks',
    },
    { '<leader>md', "<cmd>lua require('markit').delete_line()<cr>", desc = 'Delete Line' },
    { '<leader>mh', "<cmd>lua require('markit').next_bookmark()<cr>", desc = 'Next Bookmark' },
    { '<leader>mj', "<cmd>lua require('markit').next()<cr>", desc = 'Next' },
    { '<leader>mk', "<cmd>lua require('markit').prev()<cr>", desc = 'Previous' },
    { '<leader>ml', "<cmd>lua require('markit').prev_bookmark()<cr>", desc = 'Previous Bookmark' },
    ...
    { '<leader>wr', '<cmd>%d+<cr>', desc = 'Remove All Text' },
